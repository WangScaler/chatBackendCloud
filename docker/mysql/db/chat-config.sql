...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (5, 32, 'chat-modules-dev.yml', 'DEFAULT_GROUP', '', '# spring配置\nspring:\n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: 123456\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://192.168.1.11:3306/chat-new?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8&&allowPublicKeyRetrieval=true\n          username: root\n          password: 123456\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.wangscaler\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 系统模块接口文档\n  license: Powered By WangScaler\n  licenseUrl: https://blog.dilicili.cn', '9039a7a130341f906d494292a61576b8', '2023-06-13 10:04:31', '2023-06-13 10:04:31', 'nacos', '192.168.48.1', 'U', '', NULL);
INSERT INTO `his_config_info` VALUES (2, 33, 'chat-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    gateway:\n      globalcors:\n        add-to-simple-url-handler-mapping: true #解决OPTION被拦截的问题\n        cors-configurations:\n          \'[/**]\':\n            allowedOrigins: # 允许哪些网站的跨域请求\n              - \"http://blog.dilicili.cn\"\n              - \"http://chat.dilicili.cn\"\n            allowedMethods: #允许的请求方式\n              - \"GET\"\n              - \"POST\"\n              - \"DELETE\"\n              - \"PUT\"\n              - \"OPTIONS\"\n            allowedHeaders: \"*\" #允许在请求中携带头信息\n            allowedCredentials: true #是否允许携带cookie\n            maxAge: 360000 #跨越的有效期\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        - id: chat-user #路由标识\n          uri: lb://chat-user #路由的目标地址\n          predicates:\n            - Path=/user/** # 路径断言\n          # filters:\n            # - PrefixPath=/user\n            # - StripPrefix=1\n        - id: chat-room #路由标识\n          uri: lb://chat-room #路由的目标地址\n          predicates:\n              - Path=/room/** # 路径断言\n          # filters:\n            # - PrefixPath=/room\n            # - StripPrefix=1\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    enabled: true\n  crypto:\n    enabled: false\n  # 不校验白名单\n  ignore:\n    whites:\n      - /*/v2/api-docs\n      - /csrf\n      - /user/login\n      - /user/registry', '6d02bc312f1cc0ac9a3c80935997493a', '2023-06-13 10:05:19', '2023-06-13 10:05:19', 'nacos', '192.168.48.1', 'U', '', NULL);
INSERT INTO `his_config_info` VALUES (2, 34, 'chat-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    gateway:\n      globalcors:\n        add-to-simple-url-handler-mapping: true #解决OPTION被拦截的问题\n        cors-configurations:\n          \'[/**]\':\n            allowedOrigins: # 允许哪些网站的跨域请求\n              - \"http://blog.dilicili.cn\"\n              - \"http://chat.dilicili.cn\"\n            allowedMethods: #允许的请求方式\n              - \"GET\"\n              - \"POST\"\n              - \"DELETE\"\n              - \"PUT\"\n              - \"OPTIONS\"\n            allowedHeaders: \"*\" #允许在请求中携带头信息\n            allowedCredentials: true #是否允许携带cookie\n            maxAge: 360000 #跨越的有效期\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        - id: chat-user #路由标识\n          uri: lb://chat-user #路由的目标地址\n          predicates:\n            - Path=/user/** # 路径断言\n          # filters:\n            # - PrefixPath=/user\n            # - StripPrefix=1\n        - id: chat-room #路由标识\n          uri: lb://chat-room #路由的目标地址\n          predicates:\n              - Path=/room/** # 路径断言\n          # filters:\n            # - PrefixPath=/room\n            # - StripPrefix=1\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    enabled: true\n  crypto:\n    enabled: false\n  # 不校验白名单\n  ignore:\n    whites:\n      - /*/*/v2/api-docs\n      - /csrf\n      - /user/login\n      - /user/registry', 'e9dd03a7eb8138a79787dcabd5dbff0d', '2023-06-13 10:05:49', '2023-06-13 10:05:50', 'nacos', '192.168.48.1', 'U', '', NULL);
INSERT INTO `his_config_info` VALUES (2, 35, 'chat-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    gateway:\n      globalcors:\n        add-to-simple-url-handler-mapping: true #解决OPTION被拦截的问题\n        cors-configurations:\n          \'[/**]\':\n            allowedOrigins: # 允许哪些网站的跨域请求\n              - \"http://blog.dilicili.cn\"\n              - \"http://chat.dilicili.cn\"\n            allowedMethods: #允许的请求方式\n              - \"GET\"\n              - \"POST\"\n              - \"DELETE\"\n              - \"PUT\"\n              - \"OPTIONS\"\n            allowedHeaders: \"*\" #允许在请求中携带头信息\n            allowedCredentials: true #是否允许携带cookie\n            maxAge: 360000 #跨越的有效期\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        - id: chat-user #路由标识\n          uri: lb://chat-user #路由的目标地址\n          predicates:\n            - Path=/user/** # 路径断言\n          # filters:\n            # - PrefixPath=/user\n            # - StripPrefix=1\n        - id: chat-room #路由标识\n          uri: lb://chat-room #路由的目标地址\n          predicates:\n              - Path=/room/** # 路径断言\n          # filters:\n            # - PrefixPath=/room\n            # - StripPrefix=1\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    enabled: true\n  crypto:\n    enabled: false\n  # 不校验白名单\n  ignore:\n    whites:\n      - /*/v2/api-docs\n      - /csrf\n      - /user/login\n      - /user/registry', '6d02bc312f1cc0ac9a3c80935997493a', '2023-06-13 10:13:19', '2023-06-13 10:13:20', 'nacos', '192.168.48.1', 'U', '', NULL);
INSERT INTO `his_config_info` VALUES (2, 36, 'chat-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    gateway:\n      globalcors:\n        add-to-simple-url-handler-mapping: true #解决OPTION被拦截的问题\n        cors-configurations:\n          \'[/**]\':\n            allowedOrigins: # 允许哪些网站的跨域请求\n              - \"http://blog.dilicili.cn\"\n              - \"http://chat.dilicili.cn\"\n            allowedMethods: #允许的请求方式\n              - \"GET\"\n              - \"POST\"\n              - \"DELETE\"\n              - \"PUT\"\n              - \"OPTIONS\"\n            allowedHeaders: \"*\" #允许在请求中携带头信息\n            allowedCredentials: true #是否允许携带cookie\n            maxAge: 360000 #跨越的有效期\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        - id: chat-user #路由标识\n          uri: lb://chat-user #路由的目标地址\n          predicates:\n            - Path=/user/** # 路径断言\n        - id: chat-user #路由标识\n          uri: lb://chat-user #路由的目标地址\n          predicates:\n            - Path=/user/v2/api-docs # 路径断言\n          filters:\n            #- PrefixPath=/user\n            - StripPrefix=1\n        - id: chat-room #路由标识\n          uri: lb://chat-room #路由的目标地址\n          predicates:\n              - Path=/room/** # 路径断言\n          # filters:\n            # - PrefixPath=/room\n            # - StripPrefix=1\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    enabled: true\n  crypto:\n    enabled: false\n  # 不校验白名单\n  ignore:\n    whites:\n      - /*/v2/api-docs\n      - /csrf\n      - /user/login\n      - /user/registry', 'd609a2563c106d24199ad3d59915c483', '2023-06-13 10:15:03', '2023-06-13 10:15:03', 'nacos', '192.168.48.1', 'U', '', NULL);
INSERT INTO `his_config_info` VALUES (2, 37, 'chat-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    gateway:\n      globalcors:\n        add-to-simple-url-handler-mapping: true #解决OPTION被拦截的问题\n        cors-configurations:\n          \'[/**]\':\n            allowedOrigins: # 允许哪些网站的跨域请求\n              - \"http://blog.dilicili.cn\"\n              - \"http://chat.dilicili.cn\"\n            allowedMethods: #允许的请求方式\n              - \"GET\"\n              - \"POST\"\n              - \"DELETE\"\n              - \"PUT\"\n              - \"OPTIONS\"\n            allowedHeaders: \"*\" #允许在请求中携带头信息\n            allowedCredentials: true #是否允许携带cookie\n            maxAge: 360000 #跨越的有效期\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        - id: chat-user #路由标识\n          uri: lb://chat-user #路由的目标地址\n          predicates:\n            - Path=/user/** # 路径断言\n          filters:\n            - StripPrefix=1\n        - id: chat-room #路由标识\n          uri: lb://chat-room #路由的目标地址\n          predicates:\n              - Path=/room/** # 路径断言\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    enabled: true\n  crypto:\n    enabled: false\n  # 不校验白名单\n  ignore:\n    whites:\n      - /*/v2/api-docs\n      - /csrf\n      - /user/login\n      - /user/registry', '531442f9dd16faf3853a7b0c0e8524d0', '2023-06-13 10:20:00', '2023-06-13 10:20:00', 'nacos', '192.168.48.1', 'U', '', NULL);
